...
%sample
a="test.bin"
fxcopy a,"c:¥¥temp"	; "test.bin"をC:¥tempにコピー
...
p2(0)   : 取得モード(0=すべてのバッファ,1=バッファ内の改行まで)
...
p2で取得モードを指定することができます。0の場合は、パイプから取得された実行結果全体を返します。1を指定した場合は、改行まで(1行単位)で実行結果を取得します。
