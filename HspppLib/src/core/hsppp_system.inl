...
namespace hsppp {
    ...
    int64_t hwnd(const std::source_location& location) {
        return safe_call(location, [&]() -> int64_t {
    ...
    int64_t hdc(const std::source_location& location) {
        return safe_call(location, [&]() -> int64_t {
    ...
    int64_t hinstance(const std::source_location& location) {
        return safe_call(location, [&]() -> int64_t {
    ...
    int64_t sendmsg(int64_t hwndValue, int msg, int64_t wparam, int64_t lparam, const std::source_location& location) {
        return safe_call(location, [&]() -> int64_t {
    ...
    int64_t sendmsg(int64_t hwndValue, int msg, int64_t wparam, std::string_view lparamText, const std::source_location& location) {
        return safe_call(location, [&]() -> int64_t {
